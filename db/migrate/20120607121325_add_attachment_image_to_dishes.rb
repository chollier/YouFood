class AddAttachmentImageToDishes < ActiveRecord::Migration
  def self.up
    ...
    add_column :dishes, :image_file_size, :integer
    add_column :dishes, :image_updated_at, :datetime
  end

  def self.down
    remove_column :dishes, :image_file_name
    remove_column :dishes, :image_content_type
    remove_column :dishes, :image_file_size
    remove_column :dishes, :image_updated_at
  end
end
